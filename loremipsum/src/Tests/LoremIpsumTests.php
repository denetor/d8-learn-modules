...
class LoremIpsumTests extends WebTestBase {
    ...
    public function testConfigForm() {
        ...
        $this->assertFieldByName(
                'page_title', $config->get('loremipsum.settings.page_title'), 'Page title field has the default value'
        );
        $this->assertFieldByName(
                'source_text', $config->get('loremipsum.settings.source_text'), 'Source text field has the default value'
        );
        ...
        $this->assertText(
                'The configuration options have been saved.', 'The form was saved correctly.'
        );
        ...
        $this->assertResponse(200);
        $this->assertFieldByName(
                'page_title', 'Test lorem ipsum', 'Page title is OK.'
        );
        $this->assertFieldByName(
                'source_text', 'Test phrase 1 \nTest phrase 2 \nTest phrase 3 \n', 'Source text is OK.'
        );
